...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (typeof GlobalGameState !== 'undefined') {
        ...
        window.globalGameState.loadGameData();
...
function loadOpeningAnimation() {
    console.log('Loading Opening Animation...');
    ...
    setTimeout(() => {
        window.location.href = 'opening-animation.html';
    }, 500);
}

function loadFinalGate() {
    console.log('Loading Final Gate...');
    ...
    setTimeout(() => {
        window.location.href = 'final-gate.html';
    }, 500);
}
...
// Testing function
function unlockAllKeysForTesting() {
    console.log('Unlocking all energy keys for testing...');
