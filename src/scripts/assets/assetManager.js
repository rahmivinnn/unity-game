...
export class AssetManager {
  ...
  getModel(name, simObject, transparent = false) {
    console.log(`Getting model: ${name}, available models:`, Object.keys(this.models));
    if (!this.models[name]) {
      console.error(`Model '${name}' not found!`);
      return new THREE.Mesh(new THREE.BoxGeometry(1, 0.1, 1), new THREE.MeshBasicMaterial({color: 0x00ff00}));
    }
